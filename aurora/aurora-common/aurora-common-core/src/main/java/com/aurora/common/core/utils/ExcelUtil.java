...
import com.aurora.common.core.annotation.Excel;
import com.aurora.common.core.annotation.Excels;
import com.aurora.common.core.exception.UtilException;
import com.aurora.common.core.utils.file.FilePath;
import com.aurora.common.core.utils.file.FileTypeUtil;
import com.aurora.common.core.utils.file.FileUtil;
import com.aurora.common.core.utils.file.ImageUtil;
...
public class ExcelUtil<T> {
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column) {
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StringUtils.isNotEmpty(dateFormat) && StringUtil.isNotNull(value)) {
                    cell.setCellValue(DateUtil.parseDateToStr(dateFormat, (Date) value));
                } else if (StringUtils.isNotEmpty(readConverterExp) && StringUtil.isNotNull(value)) {
                    cell.setCellValue(convertByExp(Convert.toStr(value), readConverterExp, separator));
                } else if (StringUtils.isNotEmpty(dictType) && StringUtil.isNotNull(value)) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = FilePath.getDownloadPath() + filename;
    ...
    private Object getValue(Object o, String name) throws Exception {
        if (StringUtil.isNotNull(o) && StringUtils.isNotEmpty(name)) {
