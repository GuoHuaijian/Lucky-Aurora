<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="访问地点" prop="location">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:visitlog:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:visitlog:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="登录地址" align="center" prop="visitIp" width="130" :show-overflow-tooltip="true" />
      <el-table-column label="登录地点" align="center" prop="visitLocation" :show-overflow-tooltip="true" />
...
<script>
import { list, delVisitLog, cleanVisitLog, exportVisitLog } from "@/api/system/log/visit";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除日志编号为"' + visitIds + '"的数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function() {
        return delVisitLog(visitIds);
      }).then(() => {
        this.getList();
    ...
    /** 清空按钮操作 */
    handleClean() {
      this.$confirm('是否确认清空所有访问日志数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function() {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有访问日志数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(() => {
        this.exportLoading = true;
        return exportVisitLog(queryParams);
      }).then(response => {
